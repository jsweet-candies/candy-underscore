...
public abstract class Underscore<T> extends def.js.Object {
    native public T[] each(ListIterator<T,Void> iterator, Object context);
    native public T[] each(ObjectIterator<T,Void> iterator, Object context);
    native public T[] forEach(ListIterator<T,Void> iterator, Object context);
    native public T[] forEach(ObjectIterator<T,Void> iterator, Object context);
    native public <TResult> TResult[] map(ListIterator<T,TResult> iterator, Object context);
    native public <TResult> TResult[] map(ObjectIterator<T,TResult> iterator, Object context);
    native public <TResult> TResult[] collect(ListIterator<T,TResult> iterator, Object context);
    native public <TResult> TResult[] collect(ObjectIterator<T,TResult> iterator, Object context);
    native public <TResult> TResult reduce(MemoIterator<T,TResult> iterator, TResult memo, Object context);
    native public <TResult> TResult inject(MemoIterator<T,TResult> iterator, TResult memo, Object context);
    native public <TResult> TResult foldl(MemoIterator<T,TResult> iterator, TResult memo, Object context);
    native public <TResult> TResult reduceRight(MemoIterator<T,TResult> iterator, TResult memo, Object context);
    native public <TResult> TResult foldr(MemoIterator<T,TResult> iterator, TResult memo, Object context);
    native public <T> T find(ListIterator<T,Boolean> iterator, Object context);
    native public <T,U extends java.lang.Object> T find(U interator);
    native public <T> T find(String interator);
    native public <T> T detect(ListIterator<T,Boolean> iterator, Object context);
    native public <T,U extends java.lang.Object> T detect(U interator);
    native public <T> T detect(String interator);
    native public T[] filter(ListIterator<T,Boolean> iterator, Object context);
    native public T[] select(ListIterator<T,Boolean> iterator, Object context);
    ...
    native public T[] reject(ListIterator<T,Boolean> iterator, Object context);
    native public Boolean all(ListIterator<T,Boolean> iterator, Object context);
    native public Boolean every(ListIterator<T,Boolean> iterator, Object context);
    native public Boolean any(ListIterator<T,Boolean> iterator, Object context);
    native public Boolean some(ListIterator<T,Boolean> iterator, Object context);
    ...
    native public T[] sortBy(ListIterator<T,?> iterator, Object context);
    native public T[] sortBy(String iterator, Object context);
    native public Dictionary<List<T>> groupBy(ListIterator<T,?> iterator, Object context);
    native public Dictionary<T[]> groupBy(String iterator, Object context);
    native public Dictionary<T> indexBy(ListIterator<T,?> iterator, Object context);
    native public Dictionary<T> indexBy(String iterator, Object context);
    native public Dictionary<Double> countBy(ListIterator<T,?> iterator, Object context);
    native public Dictionary<Double> countBy(String iterator, Object context);
    ...
    native public T[][] partition(ListIterator<T,Boolean> iterator, Object context);
    native public T[] union(@SuppressWarnings("unchecked") List<T>... arrays);
    native public T[] intersection(@SuppressWarnings("unchecked") List<T>... arrays);
    native public T[] difference(@SuppressWarnings("unchecked") List<T>... others);
    native public T[] uniq(Boolean isSorted, ListIterator<T,?> iterator);
    native public <TSort> T[] uniq(ListIterator<T,TSort> iterator, Object context);
    native public <TSort> T[] unique(Boolean isSorted, ListIterator<T,TSort> iterator);
    native public <TSort> T[] unique(ListIterator<T,TSort> iterator, Object context);
    ...
    native public jsweet.util.union.Union<Function,Cancelable> throttle(double wait, ThrottleSettings options);
    native public jsweet.util.union.Union<Function,Cancelable> debounce(double wait, Boolean immediate);
    ...
    native public Object findKey(ObjectIterator<?,Boolean> predicate, Object context);
    ...
    native public <TResult> ListIterator<T,TResult> matches();
    native public <TResult> ListIterator<T,TResult> matcher();
    ...
    native public java.util.function.Function<Object,String> template(TemplateSettings settings);
    native public _Chain<T> chain();
    native public <TResult> TResult value();
    native public T[] each(ListIterator<T,Void> iterator);
    native public T[] each(ObjectIterator<T,Void> iterator);
    native public T[] forEach(ListIterator<T,Void> iterator);
    native public T[] forEach(ObjectIterator<T,Void> iterator);
    native public <TResult> TResult[] map(ListIterator<T,TResult> iterator);
    native public <TResult> TResult[] map(ObjectIterator<T,TResult> iterator);
    native public <TResult> TResult[] collect(ListIterator<T,TResult> iterator);
    native public <TResult> TResult[] collect(ObjectIterator<T,TResult> iterator);
    native public <TResult> TResult reduce(MemoIterator<T,TResult> iterator, TResult memo);
    native public <TResult> TResult reduce(MemoIterator<T,TResult> iterator);
    native public <TResult> TResult inject(MemoIterator<T,TResult> iterator, TResult memo);
    native public <TResult> TResult inject(MemoIterator<T,TResult> iterator);
    native public <TResult> TResult foldl(MemoIterator<T,TResult> iterator, TResult memo);
    native public <TResult> TResult foldl(MemoIterator<T,TResult> iterator);
    native public <TResult> TResult reduceRight(MemoIterator<T,TResult> iterator, TResult memo);
    native public <TResult> TResult reduceRight(MemoIterator<T,TResult> iterator);
    native public <TResult> TResult foldr(MemoIterator<T,TResult> iterator, TResult memo);
    native public <TResult> TResult foldr(MemoIterator<T,TResult> iterator);
    native public <T> T find(ListIterator<T,Boolean> iterator);
    native public <T> T detect(ListIterator<T,Boolean> iterator);
    native public <T,U extends java.lang.Object> T detect();
    native public T[] filter(ListIterator<T,Boolean> iterator);
    native public T[] select(ListIterator<T,Boolean> iterator);
    native public T[] reject(ListIterator<T,Boolean> iterator);
    native public Boolean all(ListIterator<T,Boolean> iterator);
    native public Boolean all();
    native public Boolean every(ListIterator<T,Boolean> iterator);
    native public Boolean every();
    native public Boolean any(ListIterator<T,Boolean> iterator);
    native public Boolean any();
    native public Boolean some(ListIterator<T,Boolean> iterator);
    ...
    native public T max(ListIterator<T,Double> iterator);
    native public T min(ListIterator<T,Double> iterator);
    native public T[] sortBy(ListIterator<T,?> iterator);
    native public T[] sortBy();
    native public T[] sortBy(String iterator);
    native public Dictionary<List<T>> groupBy(ListIterator<T,?> iterator);
    native public Dictionary<List<T>> groupBy();
    native public Dictionary<T[]> groupBy(String iterator);
    native public Dictionary<T> indexBy(ListIterator<T,?> iterator);
    native public Dictionary<T> indexBy(String iterator);
    native public Dictionary<Double> countBy(ListIterator<T,?> iterator);
    native public Dictionary<Double> countBy();
    native public Dictionary<Double> countBy(String iterator);
    native public T[] initial();
    native public T[] rest();
    native public T[] tail();
    native public T[] drop();
    native public Object[] flatten();
    native public T[][] partition(ListIterator<T,Boolean> iterator);
    native public T[] uniq(Boolean isSorted);
    native public T[] uniq();
    native public <TSort> T[] uniq(ListIterator<T,TSort> iterator);
    native public <TSort> T[] unique(Boolean isSorted);
    native public <TSort> T[] unique();
    native public <TSort> T[] unique(ListIterator<T,TSort> iterator);
    ...
    native public jsweet.util.union.Union<Function,Cancelable> throttle(double wait);
    native public jsweet.util.union.Union<Function,Cancelable> debounce(double wait);
    native public Function restArgs();
    native public Object findKey(ObjectIterator<?,Boolean> predicate);
    ...
    native public <T> T find(ObjectIterator<T,Boolean> iterator, Object context);
    native public <T> T detect(ObjectIterator<T,Boolean> iterator, Object context);
    ...
    native public <T> T find(ObjectIterator<T,Boolean> iterator);
    native public <T> T detect(ObjectIterator<T,Boolean> iterator);
