...
declare namespace _ {
    export interface Underscore<T> {
        each(iterator: _.ListIterator<T, void>, context: any);

        each(iterator: _.ObjectIterator<T, void>, context: any);

        forEach(iterator: _.ListIterator<T, void>, context: any);

        forEach(iterator: _.ObjectIterator<T, void>, context: any);

        map<TResult>(iterator: _.ListIterator<T, TResult>, context: any);

        map<TResult>(iterator: _.ObjectIterator<T, TResult>, context: any);

        collect<TResult>(iterator: _.ListIterator<T, TResult>, context: any);

        collect<TResult>(iterator: _.ObjectIterator<T, TResult>, context: any);
        ...
        filter(iterator: _.ListIterator<T, boolean>, context: any);

        select(iterator: _.ListIterator<T, boolean>, context: any);

        where<U extends any>(properties: U);

        findWhere<U extends any>(properties: U): T;

        reject(iterator: _.ListIterator<T, boolean>, context: any);
        ...
        sortBy(iterator: _.ListIterator<T, any>, context: any);

        sortBy(iterator: string, context: any);
        ...
        flatten(shallow: boolean);

        without(...values: T[]);

        partition(iterator: _.ListIterator<T, boolean>, context: any);

        union(...arrays: _.List<T>[]);

        intersection(...arrays: _.List<T>[]);

        difference(...others: _.List<T>[]);

        uniq(isSorted: boolean, iterator: _.ListIterator<T, any>);

        uniq<TSort>(iterator: _.ListIterator<T, TSort>, context: any);

        unique<TSort>(isSorted: boolean, iterator: _.ListIterator<T, TSort>);

        unique<TSort>(iterator: _.ListIterator<T, TSort>, context: any);
        ...
        indexOf(value: T, isSorted: boolean);

        indexOf(value: T, startFrom: number);

        lastIndexOf(value: T, from: number);

        findIndex<T>(array: _.List<T>, predicate: _.ListIterator<T, boolean>, context: any);

        findLastIndex<T>(array: _.List<T>, predicate: _.ListIterator<T, boolean>, context: any);

        sortedIndex(value: T, iterator: (p1: T) => any, context: any);
        ...
        times<TResult>(iterator: (p1: number) => TResult, context: any);
        ...
        each(iterator: _.ListIterator<T, void>);

        each(iterator: _.ObjectIterator<T, void>);

        forEach(iterator: _.ListIterator<T, void>);

        forEach(iterator: _.ObjectIterator<T, void>);

        map<TResult>(iterator: _.ListIterator<T, TResult>);

        map<TResult>(iterator: _.ObjectIterator<T, TResult>);

        collect<TResult>(iterator: _.ListIterator<T, TResult>);

        collect<TResult>(iterator: _.ObjectIterator<T, TResult>);
        ...
        filter(iterator: _.ListIterator<T, boolean>);

        select(iterator: _.ListIterator<T, boolean>);

        reject(iterator: _.ListIterator<T, boolean>);
        ...
        sortBy(iterator: _.ListIterator<T, any>);

        sortBy();

        sortBy(iterator: string);
        ...
        partition(iterator: _.ListIterator<T, boolean>);

        uniq(isSorted: boolean);

        uniq();

        uniq<TSort>(iterator: _.ListIterator<T, TSort>);

        unique<TSort>(isSorted: boolean);

        unique<TSort>();

        unique<TSort>(iterator: _.ListIterator<T, TSort>);
        ...
        findIndex<T>(array: _.List<T>, predicate: _.ListIterator<T, boolean>);

        findLastIndex<T>(array: _.List<T>, predicate: _.ListIterator<T, boolean>);

        sortedIndex(value: T, iterator: (p1: T) => any);
        ...
        times<TResult>(iterator: (p1: number) => TResult);
        ...
        findIndex<T>(array: _.List<T>, predicate: any, context: any);

        findLastIndex<T>(array: _.List<T>, predicate: any, context: any);

        find<T>(iterator: _.ObjectIterator<T, boolean>): T;

        detect<T>(iterator: _.ObjectIterator<T, boolean>): T;

        findIndex<T>(array: _.List<T>, predicate: any);

        findLastIndex<T>(array: _.List<T>, predicate: any);

        findIndex<T>(array: T[], predicate: _.ListIterator<T, boolean>, context: any);

        findLastIndex<T>(array: T[], predicate: _.ListIterator<T, boolean>, context: any);

        findIndex<T>(array: T[], predicate: _.ListIterator<T, boolean>);

        findLastIndex<T>(array: T[], predicate: _.ListIterator<T, boolean>);

        findIndex<T>(array: T[], predicate: any, context: any);

        findLastIndex<T>(array: T[], predicate: any, context: any);

        findIndex<T>(array: T[], predicate: any);
...
declare namespace _ {
    export interface UnderscoreStatic {
        ...
        map<T, TResult>(list: _.List<T>, iterator: any, context: any);

        map<T, TResult>(object: _.Dictionary<T>, iterator: _.ObjectIterator<T, TResult>, context: any);

        collect<T, TResult>(list: _.List<T>, iterator: any, context: any);

        collect<T, TResult>(object: _.Dictionary<T>, iterator: _.ObjectIterator<T, TResult>, context: any);
        ...
        filter<T>(list: _.List<T>, iterator: _.ListIterator<T, boolean>, context: any);

        filter<T>(object: _.Dictionary<T>, iterator: _.ObjectIterator<T, boolean>, context: any);

        select<T>(list: _.List<T>, iterator: _.ListIterator<T, boolean>, context: any);

        select<T>(object: _.Dictionary<T>, iterator: _.ObjectIterator<T, boolean>, context: any);

        where<T, U extends any>(list: _.List<T>, properties: U);

        findWhere<T, U extends any>(list: _.List<T>, properties: U): T;

        reject<T>(list: _.List<T>, iterator: _.ListIterator<T, boolean>, context: any);

        reject<T>(object: _.Dictionary<T>, iterator: _.ObjectIterator<T, boolean>, context: any);
        ...
        pluck<T extends any>(list: _.List<T>, propertyName: string);
         ...
         * @return {number}
         */
        max(object: _.Dictionary<number>);
        ...
        sortBy<T, TSort>(list: _.List<T>, iterator: _.ListIterator<T, TSort>, context: any);

        sortBy<T>(list: _.List<T>, iterator: string, context: any);
        ...
        shuffle<T>(list: _.Collection<T>);

        sample<T>(list: _.Collection<T>, n: number);

        sample<T>(list: _.Collection<T>): T;

        toArray<T>(list: _.Collection<T>);

        size<T>(list: _.Collection<T>);

        partition<T>(array: Array<T>, iterator: _.ListIterator<T, boolean>, context: any);

        first<T>(array: _.List<T>): T;

        first<T>(array: _.List<T>, n: number);

        head<T>(array: _.List<T>): T;

        head<T>(array: _.List<T>, n: number);

        take<T>(array: _.List<T>): T;

        take<T>(array: _.List<T>, n: number);

        initial<T>(array: _.List<T>, n: number);

        last<T>(array: _.List<T>): T;

        last<T>(array: _.List<T>, n: number);

        rest<T>(array: _.List<T>, n: number);

        tail<T>(array: _.List<T>, n: number);

        drop<T>(array: _.List<T>, n: number);

        compact<T>(array: _.List<T>);

        flatten(array: _.List<any>, shallow: boolean);

        without<T>(array: _.List<T>, ...values: T[]);

        union<T>(...arrays: _.List<T>[]);

        intersection<T>(...arrays: _.List<T>[]);

        difference<T>(array: _.List<T>, ...others: _.List<T>[]);

        uniq<T, TSort>(array: _.List<T>, isSorted: boolean, iterator: _.ListIterator<T, TSort>, context: any);

        uniq<T, TSort>(array: _.List<T>, iterator: _.ListIterator<T, TSort>, context: any);

        unique<T, TSort>(array: _.List<T>, iterator: _.ListIterator<T, TSort>, context: any);

        unique<T, TSort>(array: _.List<T>, isSorted: boolean, iterator: _.ListIterator<T, TSort>, context: any);
        ...
        indexOf<T>(array: _.List<T>, value: T, isSorted: boolean);

        indexOf<T>(array: _.List<T>, value: T, startFrom: number);

        lastIndexOf<T>(array: _.List<T>, value: T, from: number);

        findIndex<T>(array: _.List<T>, predicate: _.ListIterator<T, boolean>, context: any);

        findLastIndex<T>(array: _.List<T>, predicate: _.ListIterator<T, boolean>, context: any);

        sortedIndex<T, TSort>(list: _.List<T>, value: T, iterator: (p1: T) => TSort, context: any);
        ...
        values<T>(object: _.Dictionary<T>);
        ...
        times<TResult>(n: number, iterator: (p1: number) => TResult, context: any);
        ...
        map<T, TResult>(list: _.List<T>, iterator: any);

        map<T, TResult>(object: _.Dictionary<T>, iterator: _.ObjectIterator<T, TResult>);

        collect<T, TResult>(list: _.List<T>, iterator: any);

        collect<T, TResult>(object: _.Dictionary<T>, iterator: _.ObjectIterator<T, TResult>);
        ...
        filter<T>(list: _.List<T>, iterator: _.ListIterator<T, boolean>);

        filter<T>(object: _.Dictionary<T>, iterator: _.ObjectIterator<T, boolean>);

        select<T>(list: _.List<T>, iterator: _.ListIterator<T, boolean>);

        select<T>(object: _.Dictionary<T>, iterator: _.ObjectIterator<T, boolean>);

        reject<T>(list: _.List<T>, iterator: _.ListIterator<T, boolean>);

        reject<T>(object: _.Dictionary<T>, iterator: _.ObjectIterator<T, boolean>);
        ...
        sortBy<T, TSort>(list: _.List<T>, iterator: _.ListIterator<T, TSort>);

        sortBy<T, TSort>(list: _.List<T>);

        sortBy<T>(list: _.List<T>, iterator: string);
        ...
        partition<T>(array: Array<T>, iterator: _.ListIterator<T, boolean>);
        ...
        uniq<T, TSort>(array: _.List<T>, isSorted: boolean, iterator: _.ListIterator<T, TSort>);

        uniq<T, TSort>(array: _.List<T>, isSorted: boolean);

        uniq<T, TSort>(array: _.List<T>);

        uniq<T, TSort>(array: _.List<T>, iterator: _.ListIterator<T, TSort>);

        unique<T, TSort>(array: _.List<T>, iterator: _.ListIterator<T, TSort>);

        unique<T, TSort>(array: _.List<T>);

        unique<T, TSort>(array: _.List<T>, isSorted: boolean, iterator: _.ListIterator<T, TSort>);

        unique<T, TSort>(array: _.List<T>, isSorted: boolean);

        object<TResult extends any>(list: _.List<any>): TResult;

        indexOf<T>(array: _.List<T>, value: T);

        lastIndexOf<T>(array: _.List<T>, value: T);

        findIndex<T>(array: _.List<T>, predicate: _.ListIterator<T, boolean>);

        findLastIndex<T>(array: _.List<T>, predicate: _.ListIterator<T, boolean>);

        sortedIndex<T, TSort>(list: _.List<T>, value: T, iterator: (p1: T) => TSort);

        sortedIndex<T, TSort>(list: _.List<T>, value: T);
        ...
        times<TResult>(n: number, iterator: (p1: number) => TResult);
        ...
        uniq<T, TSort>(array: _.List<T>, isSorted: boolean, iterator: string, context: any);

        uniq<T, TSort>(array: _.List<T>, isSorted: boolean, iterator: number, context: any);

        unique<T, TSort>(array: _.List<T>, iterator: number, context: any);

        unique<T, TSort>(array: _.List<T>, iterator: string, context: any);

        findIndex<T>(array: _.List<T>, predicate: any, context: any);

        findLastIndex<T>(array: _.List<T>, predicate: any, context: any);

        uniq<T, TSort>(array: _.List<T>, isSorted: boolean, iterator: number);

        uniq<T, TSort>(array: _.List<T>, isSorted: boolean, iterator: string);

        unique<T, TSort>(array: _.List<T>, iterator: string);

        unique<T, TSort>(array: _.List<T>, iterator: number);
        ...
        map<T, TResult>(list: T[], iterator: any, context: any);

        collect<T, TResult>(list: T[], iterator: any, context: any);
        ...
        filter<T>(list: T[], iterator: _.ListIterator<T, boolean>, context: any);

        select<T>(list: T[], iterator: _.ListIterator<T, boolean>, context: any);

        where<T, U extends any>(list: T[], properties: U);

        findWhere<T, U extends any>(list: T[], properties: U): T;

        reject<T>(list: T[], iterator: _.ListIterator<T, boolean>, context: any);
        ...
        pluck<T extends any>(list: T[], propertyName: string);
        ...
        sortBy<T, TSort>(list: T[], iterator: _.ListIterator<T, TSort>, context: any);

        sortBy<T>(list: T[], iterator: string, context: any);
        ...
        partition<T>(array: T[], iterator: _.ListIterator<T, boolean>, context: any);

        first<T>(array: T[]): T;

        first<T>(array: T[], n: number);

        head<T>(array: T[]): T;

        head<T>(array: T[], n: number);

        take<T>(array: T[]): T;

        take<T>(array: T[], n: number);

        initial<T>(array: T[], n: number);

        last<T>(array: T[]): T;

        last<T>(array: T[], n: number);

        rest<T>(array: T[], n: number);

        tail<T>(array: T[], n: number);

        drop<T>(array: T[], n: number);

        compact<T>(array: T[]);

        flatten(array: any[], shallow: boolean);

        without<T>(array: T[], ...values: T[]);

        difference<T>(array: T[], ...others: _.List<T>[]);

        uniq<T, TSort>(array: T[], isSorted: boolean, iterator: _.ListIterator<T, TSort>, context: any);

        uniq<T, TSort>(array: T[], iterator: _.ListIterator<T, TSort>, context: any);

        unique<T, TSort>(array: T[], iterator: _.ListIterator<T, TSort>, context: any);

        unique<T, TSort>(array: T[], isSorted: boolean, iterator: _.ListIterator<T, TSort>, context: any);
        ...
        indexOf<T>(array: T[], value: T, isSorted: boolean);

        indexOf<T>(array: T[], value: T, startFrom: number);

        lastIndexOf<T>(array: T[], value: T, from: number);

        findIndex<T>(array: T[], predicate: _.ListIterator<T, boolean>, context: any);

        findLastIndex<T>(array: T[], predicate: _.ListIterator<T, boolean>, context: any);

        sortedIndex<T, TSort>(list: T[], value: T, iterator: (p1: T) => TSort, context: any);

        each<T>(list: T[], iterator: _.ListIterator<T, void>): _.List<T>;

        forEach<T>(list: T[], iterator: _.ListIterator<T, void>): _.List<T>;

        map<T, TResult>(list: T[], iterator: any);

        collect<T, TResult>(list: T[], iterator: any);

        find<T>(list: T[], iterator: _.ListIterator<T, boolean>): T;

        detect<T>(list: T[], iterator: _.ListIterator<T, boolean>): T;

        filter<T>(list: T[], iterator: _.ListIterator<T, boolean>);

        select<T>(list: T[], iterator: _.ListIterator<T, boolean>);

        reject<T>(list: T[], iterator: _.ListIterator<T, boolean>);
        ...
        sortBy<T, TSort>(list: T[], iterator: _.ListIterator<T, TSort>);

        sortBy<T, TSort>(list: T[]);

        sortBy<T>(list: T[], iterator: string);
        ...
        partition<T>(array: T[], iterator: _.ListIterator<T, boolean>);
        ...
        uniq<T, TSort>(array: T[], isSorted: boolean, iterator: _.ListIterator<T, TSort>);

        uniq<T, TSort>(array: T[], isSorted: boolean);

        uniq<T, TSort>(array: T[]);

        uniq<T, TSort>(array: T[], iterator: _.ListIterator<T, TSort>);

        unique<T, TSort>(array: T[], iterator: _.ListIterator<T, TSort>);

        unique<T, TSort>(array: T[]);

        unique<T, TSort>(array: T[], isSorted: boolean, iterator: _.ListIterator<T, TSort>);

        unique<T, TSort>(array: T[], isSorted: boolean);

        object<TResult extends any>(list: any[]): TResult;

        indexOf<T>(array: T[], value: T);

        lastIndexOf<T>(array: T[], value: T);

        findIndex<T>(array: T[], predicate: _.ListIterator<T, boolean>);

        findLastIndex<T>(array: T[], predicate: _.ListIterator<T, boolean>);

        sortedIndex<T, TSort>(list: T[], value: T, iterator: (p1: T) => TSort);

        sortedIndex<T, TSort>(list: T[], value: T);

        uniq<T, TSort>(array: T[], isSorted: boolean, iterator: string, context: any);

        uniq<T, TSort>(array: T[], isSorted: boolean, iterator: number, context: any);

        unique<T, TSort>(array: T[], iterator: number, context: any);

        unique<T, TSort>(array: T[], iterator: string, context: any);

        findIndex<T>(array: T[], predicate: any, context: any);

        findLastIndex<T>(array: T[], predicate: any, context: any);

        uniq<T, TSort>(array: T[], isSorted: boolean, iterator: number);

        uniq<T, TSort>(array: T[], isSorted: boolean, iterator: string);

        unique<T, TSort>(array: T[], iterator: string);

        unique<T, TSort>(array: T[], iterator: number);
