# JSweet underscore candy

## Description

This project is a Java bridge to the underscore library, so that underscore can be used from Java (thanks to the JSweet transpiler).
